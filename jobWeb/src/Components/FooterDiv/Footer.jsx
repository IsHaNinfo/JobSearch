    ...
    items-center justify-center'>
      ...
      <div className='logoDiv'>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7'>
          We always meke our seekers and companies find the best hibs and employees find the best candidiates.
        </p>
      </div>
      <div className="grid">
      ...
      <div className='icons flex gap-4 py-[1rem]'>
        ...
        <FaTwitter className='bg-white p-[18px] h-[35px]  w-[35px] rounded-full icon text-blueColor'/>
